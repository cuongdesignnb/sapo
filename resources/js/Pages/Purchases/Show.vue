...
const totalQty =
    props.purchase.items?.reduce((s, i) => s + (Number(i.quantity) || 0), 0) ||
    0;
const totalProducts = props.purchase.items?.length || 0;
const calcTotal =
    props.purchase.items?.reduce((s, i) => s + (Number(i.subtotal) || 0), 0) ||
    0;
...
const printPurchase = () => {
    window.open(
        `/purchases/${props.purchase.id}/print`,
        "_blank",
...
const editForm = ref({
    ...
    purchase_date: getLocalDatetime(
        props.purchase.purchase_date || props.purchase.created_at,
    ),
...
const editPayAmount = computed(
    () => totalAmount - (Number(editForm.value.discount) || 0),
);
const editDebt = computed(() =>
    Math.max(
        0,
        editPayAmount.value - (Number(editForm.value.paid_amount) || 0),
    ),
);
...
<template>
    ...
    <AppLayout>
        <div class="bg-white h-full flex flex-col">
            <!-- Header -->
            <div
                class="flex items-center gap-3 px-4 py-3 border-b border-gray-200 bg-gray-50/50"
            >
                <Link
                    href="/purchases"
                ...
                <span
                    class="ml-2 inline-block px-2 py-0.5 rounded text-[11px] font-medium border"
                    :class="
            ...
            <div class="flex border-b border-gray-200 px-4">
                ...
                >
                    Trả hàng nhập
                    <span v-if="purchaseReturns && purchaseReturns.length > 0" class="ml-1 bg-red-100 text-red-600 text-[10px] font-bold px-1.5 py-0.5 rounded-full">{{ purchaseReturns.length }}</span>
                </button>
            </div>
            ...
            <div class="flex-1 overflow-auto">
                ...
                <div v-if="activeTab === 'info'" class="flex h-full">
                    ...
                    <div class="flex-1 p-5 overflow-auto">
                        <!-- Header Info Grid -->
                        <div
                            class="grid grid-cols-3 gap-x-8 gap-y-3 mb-6 text-[13px]"
                        >
                            <div class="flex gap-2">
                                <span class="text-gray-500 w-28 flex-shrink-0"
                                    >Mã nhập hàng:</span
                                >
                            ...
                            <div class="flex gap-2">
                                <span class="text-gray-500 w-32 flex-shrink-0"
                                    >Mã đặt hàng nhập:</span
                                >
                            ...
                            <div class="row-span-3">
                                <div class="flex items-start gap-2">
                                    ...
                                    <span
                                        class="text-gray-400 italic text-[13px]"
                                        >{{
                                            purchase.note || "Ghi chú..."
                                        }}</span
                                    >
                                </div>
                            </div>
                            ...
                            <div class="flex gap-2">
                                ...
                                <span class="text-blue-600 font-medium">{{
                                    purchase.supplier?.name || "Không có"
                                }}</span>
                            </div>
                            <div class="flex gap-2">
                                <span class="text-gray-500 w-32 flex-shrink-0"
                        ...
                        >
                            <table class="w-full text-[13px] text-left">
                                ...
                                >
                                    <tr>
                                        <th
                                            class="px-3 py-2 font-medium text-gray-600 w-24"
                                        >
                                            Mã hàng
                                        </th>
                                        <th
                                        ...
                                        <th
                                            class="px-3 py-2 font-medium text-gray-600 text-center w-24"
                                        >
                                            Số lượng
                                        </th>
                                        <th
                                            class="px-3 py-2 font-medium text-gray-600 text-center w-20"
                                        >
                                            Đã trả
                                        </th>
                                        <th
                                            class="px-3 py-2 font-medium text-gray-600 text-right w-28"
                                        >
                                            Đơn giá
                                        </th>
                                        <th
                                            class="px-3 py-2 font-medium text-gray-600 text-right w-24"
                                        >
                                            Giảm giá
                                        </th>
                                        <th
                                        ...
                                        <th
                                            class="px-3 py-2 font-medium text-gray-600 text-right w-28 pr-4"
                                        >
                                            Thành tiền
                                        </th>
                                    </tr>
                                    ...
                                    <tr>
                                        <th class="px-3 py-1.5">
                                            <input
                                                ...
                                                class="w-full text-[12px] text-gray-400 outline-none font-normal"
                                                disabled
                                            />
                                        </th>
                                        <th class="px-3 py-1.5">
                                ...
                                <tbody class="divide-y divide-gray-100">
                                    ...
                                    >
                                        <tr class="hover:bg-gray-50/50">
                                            ...
                                            <td
                                                class="px-3 py-2 text-right font-medium pr-4"
                                            >
                                                {{
                                                    formatCurrency(
                                                        item.subtotal,
                                        ...
                                        >
                                            <td
                                                colspan="8"
                                                class="px-6 py-1.5 bg-gray-50/50"
                                            >
                                                <div
                        ...
                        <div class="flex justify-end mt-4">
                            <div class="w-80 space-y-2 text-[13px]">
                                ...
                                <div
                                    ...
                                    v-if="purchase.debt_amount > 0"
                                >
                                    <span class="text-red-500 font-medium"
                                        >Còn nợ NCC:</span
                                    >
                                    <span class="font-bold text-red-600">{{
                                        formatCurrency(purchase.debt_amount)
                                    }}</span>
                                </div>
                                <div
                    ...
                    <div
                        class="w-[300px] flex-shrink-0 border-l border-gray-200 bg-gray-50/30 p-4 overflow-auto"
                    >
                        <div v-if="purchase.supplier" class="space-y-4">
                            ...
                            <div>
                                ...
                                <div
                                    class="font-bold text-blue-600 text-[14px]"
                                >
                            ...
                            <div class="border-t border-gray-200 pt-3 mt-3">
                                <div
                                    class="text-[11px] text-gray-400 uppercase tracking-wider mb-2"
                                >
                                    Công nợ NCC
                                </div>
                                ...
                                <div
                                    class="flex justify-between text-[13px] mt-1"
                                >
                                    <span class="text-gray-500">Tổng mua:</span>
                                    <span class="font-medium text-gray-700">{{
                                        formatCurrency(
                                            purchase.supplier.total_bought || 0,
                                        )
                                    }}</span>
                                </div>
                            </div>
                        </div>
                        <div v-else class="text-gray-400 text-[13px] italic">
                ...
                <!-- Payments Tab -->
                <div v-if="activeTab === 'payments'" class="p-5">                    <div
                        v-if="
                            purchase.cash_flows &&
                            purchase.cash_flows.length > 0
                        "
                    >
                        <table
                            class="w-full text-[13px] text-left border border-gray-200 rounded overflow-hidden"
                        >
                            <thead class="bg-gray-50 border-b border-gray-200">
                                <tr>
                                    ...
                                    <th
                                        class="px-3 py-2 font-medium text-gray-600 text-right"
                                    >
                                        Số tiền
                                    </th>
                                    <th
                            ...
                            <tbody class="divide-y divide-gray-100">
                                <tr
                                    v-for="cf in purchase.cash_flows"
                                    :key="cf.id"
                                ...
                                >
                                    ...
                                    <td class="px-3 py-2">
                                        {{
                                            formatDate(cf.time || cf.created_at)
                                        }}
                                    </td>
                                    <td
                                        class="px-3 py-2 text-right font-medium text-green-600"
                                    >
                ...
                <!-- Returns Tab -->
                <div v-if="activeTab === 'returns'" class="p-5">
                    <div v-if="purchaseReturns && purchaseReturns.length > 0">
                        <div v-for="ret in purchaseReturns" :key="ret.id" class="border border-gray-200 rounded mb-3 overflow-hidden">
                            <div class="flex items-center justify-between bg-orange-50 px-4 py-2.5 border-b border-orange-100">
                                <div class="flex items-center gap-3">
                                    <Link :href="'/purchase-returns/' + ret.id" class="text-blue-600 font-bold hover:underline">{{ ret.code }}</Link>
                                    <span class="text-[12px] text-gray-500">{{ new Date(ret.return_date || ret.created_at).toLocaleString('vi-VN') }}</span>
                                </div>
                                <span class="font-bold text-orange-600">-{{ formatCurrency(ret.total_amount) }}</span>
                            </div>
                            <div class="px-4 py-2 text-[13px] flex flex-wrap gap-3">
                                <span v-for="item in ret.items" :key="item.id" class="text-gray-600">
                                    {{ item.product_name }} &times;{{ item.quantity }} ({{ formatCurrency(item.price) }})
                                </span>
                            </div>
                        </div>
                    </div>
                    <div v-else class="text-center py-12 text-gray-400">
                        ...
                        <div class="mt-3">
                            <Link v-if="purchase.status === 'completed'" :href="'/purchase-returns/create?purchase_id=' + purchase.id"
                                class="bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded text-sm font-medium inline-flex items-center gap-1.5">
                                Tạo phiếu trả hàng
                            </Link>
                        </div>
                    </div>
            ...
            <!-- Footer Actions -->
            <div
                class="flex items-center justify-between px-4 py-3 border-t border-gray-200 bg-gray-50/50"
            >
                ...
                <form @submit.prevent="submitUpdate" class="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:ring-1 focus:ring-blue-500 focus:border-blue-500 outline-none"
                        />
                    </div>
                    ...
                    <div>
                        <label
                            class="block text-sm font-semibold text-gray-700 mb-1"
                            >Nhân viên nhập</label
                        >
                        <select
                            v-model="editForm.employee_id"
                            class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:ring-1 focus:ring-blue-500 focus:border-blue-500 outline-none bg-white"
                        >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            min="0"
                            class="w-full border border-gray-300 rounded px-3 py-2 text-sm text-right focus:ring-1 focus:ring-blue-500 focus:border-blue-500 outline-none"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            min="0"
                            class="w-full border border-gray-300 rounded px-3 py-2 text-sm text-right focus:ring-1 focus:ring-blue-500 focus:border-blue-500 outline-none font-bold text-blue-600"
                        />
                        <div class="flex justify-between mt-1 text-[12px]">
                            <span class="text-gray-500"
                                >Cần trả:
                                {{ formatCurrency(editPayAmount) }}</span
                            >
                            <span class="text-red-500" v-if="editDebt > 0"
                                >Còn nợ: {{ formatCurrency(editDebt) }}</span
                            >
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div
                            v-if="editForm.payment_method === 'transfer'"
                            class="mt-2"
                        >
                            <select
                                v-model="editForm.bank_account_info"
                                class="w-full border border-gray-300 rounded px-3 py-2 text-sm outline-none focus:border-blue-500 bg-white"
                            >
                            ...
                            <input
                                ...
                                type="text"
                                v-model="editForm.bank_account_info"
                                class="w-full border border-gray-300 rounded px-3 py-2 text-sm outline-none focus:border-blue-500 mt-1"
                    ...
                    >
                        <button
                            type="button"
                            @click="showUpdateModal = false"
                            class="px-5 py-2 border border-gray-300 rounded text-sm font-medium text-gray-700 hover:bg-gray-50"
                        >
                            Hủy
                        </button>
                        <button
                            ...
                            class="px-5 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded text-sm font-medium disabled:opacity-50 flex items-center gap-2"
                        >
                            <svg
                                v-if="isSubmitting"
