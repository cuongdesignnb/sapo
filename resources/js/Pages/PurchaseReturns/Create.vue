...
const selectedItems = computed(() =>
    items.value.filter((i) => i.selected && i.quantity > 0),
);
const totalAmount = computed(() =>
    selectedItems.value.reduce((sum, i) => sum + i.quantity * i.price, 0),
);
...
<template>
    ...
    >
        ...
        <div
            ...
            class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 text-sm flex items-center gap-2"
        >
            <svg
        ...
        >
            ...
            <div class="text-sm text-gray-500">
                Mã phiếu trả:
                <span class="font-bold text-gray-800">{{ returnCode }}</span>
            </div>
        </header>
        ...
        <div class="flex flex-1 overflow-hidden">
            ...
            <div class="flex-1 overflow-auto p-4">
                <div class="bg-white rounded shadow-sm border border-gray-200">
                    <div
                        class="px-4 py-3 border-b border-gray-200 bg-gray-50 font-bold text-gray-700"
                    >
                        Chọn sản phẩm trả lại
                    </div>
                    <table class="w-full text-left">
                        <thead
                            class="bg-gray-50 border-b border-gray-200 text-gray-500 text-[12px] uppercase"
                        >
                            <tr>
                                ...
                                <th class="p-3 text-center w-[100px]">
                                    Đã nhập
                                </th>
                                <th class="p-3 text-center w-[100px]">
                                    Có thể trả
                                ...
                                <th class="p-3 text-right w-[120px]">
                                    Đơn giá
                                </th>
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            >
                                <tr
                                    class="hover:bg-blue-50/30 cursor-pointer"
                                    :class="{ 'bg-blue-50/50': item.selected }"
                                ...
                                >
                                    ...
                                    <td class="p-3 text-center" @click.stop>
                                        <input
                                            ...
                                            class="w-[70px] border border-gray-300 rounded py-1 text-center outline-none focus:border-green-500 text-[13px]"
                                        />
                                        <span
                                            v-else-if="item.has_serial"
                                            class="font-medium"
                                            >{{ item.quantity }}</span
                                        >
                                ...
                                >
                                    <td :colspan="8" class="px-6 py-2">
                                        <div
                                            class="text-[12px] text-gray-500 mb-1.5"
                                        >
                                            Chọn Serial/IMEI cần trả:
                                        </div>
                                        ...
                                        >
                                            Không có serial nào trong kho để trả
                                        </div>
                                    </td>
                                </tr>
                            </template>
                            <tr v-if="items.length === 0">
                                ...
                                >
                                    Không có sản phẩm nào có thể trả từ phiếu
                                    nhập này.
                                </td>
                            </tr>
                        </tbody>
            ...
            <!-- Right: Summary -->
            <div
                class="w-[320px] bg-white border-l border-gray-200 flex flex-col"
            >
                <div class="flex-1 overflow-auto p-4 space-y-4">
                    <!-- Employee -->
                    <div>
                        <label class="block text-[12px] text-gray-500 mb-1"
                            >Người trả hàng</label
                        >
                        <select
                            v-model="employeeId"
                            class="w-full border border-gray-300 rounded px-2 py-1.5 text-[13px] outline-none focus:border-green-500 bg-white"
                        >
                    ...
                    <div class="space-y-2 pt-2 border-t border-gray-200">
                        ...
                        <div
                            class="flex justify-between text-[15px] pt-2 border-t border-gray-200"
                        >
                            <span class="text-gray-800 font-bold"
                                >Tổng tiền trả:</span
                            >
                            <span class="font-bold text-red-600">{{
                                formatCurrency(syncRefund)
                            }}</span>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            :max="totalAmount"
                            min="0"
                            class="w-full border border-gray-300 rounded px-2 py-1.5 text-[13px] text-right outline-none focus:border-green-500 font-bold text-blue-600"
                        />
                    </div>

                    <!-- Payment Method -->
                    <div>
                        <label class="block text-[12px] text-gray-500 mb-2"
                            >Phương thức</label
                        >
                        ...
                        <select
                            ...
                            class="w-full border border-gray-300 rounded px-2 py-1.5 text-[13px] mt-2 outline-none focus:border-blue-500 bg-white"
                        >
                    ...
                    <div>
                        <input
                            ...
                            class="w-full border border-gray-300 rounded px-2 py-1.5 text-[13px] outline-none focus:border-green-500"
                        />
                    </div>
                </div>
