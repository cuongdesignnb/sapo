...
class EmployeeSalarySettingController extends Controller
{
    ...
    public function upsert(Request $request, $employeeId)
    {
        ...
        $data = $request->validate([
            ...
            'saturday_ot_rate' => 'nullable|numeric|min:0|max:999',
            'sunday_ot_rate' => 'nullable|numeric|min:0|max:999',
            'rest_day_ot_rate' => 'nullable|numeric|min:0|max:999',
            'holiday_ot_rate' => 'nullable|numeric|min:0|max:999',
            'has_bonus' => 'boolean',
